      ...
      <ScrollView>
        ...
        <View>
          <FlatList
            ...
            numColumns={2}
          />
          <TouchableOpacity style={{marginTop: 30}} onPress={count}>
            <Text
              style={{
                alignSelf: 'center',
                fontSize: 18,
              ...
              {d == 0 ? 'Xem thêm 12 danh mục nữa' : 'Thu Gọn'}{' '}
              <Icon name={d == 0 ? 'chevron-down' : 'chevron-up'} size={17} />
            </Text>
          </TouchableOpacity>
        </View>
                  ...
                  <View>
                    <View style={[styles.imageView, {marginTop: 15}]}>
                      <TouchableOpacity
                        ...
                        <View>
                          <Text
                            style={{color: colors.grey1, textAlign: 'center'}}>
                            {item.name}
                          </Text>
                        </View>
                      </TouchableOpacity>
                      ...
                      <View style={{flexDirection: 'row'}}>
                        <TouchableOpacity
                          ...
                          <Icon1 name="shoppingcart" size={35}></Icon1>
                        </TouchableOpacity>
                        <TouchableOpacity
                          style={{
                            borderWidth: 1.25,
